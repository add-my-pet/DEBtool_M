...
k1 = 0.1; k2 = 0.2;       % dissociation rate
k1_S  = 0.0;  k2_S = 0.0; % dissociation rate
ki1_S = 0.0; ki2_S = 0.0; % dissociation rate
k1_P  = 0.0;  k2_P = 0.0; % dissociation rate
ki1_P = 0.0; ki2_P = 0.0; % dissociation rate

b1_S  = 0.06; b2_S  = 0.05; % uptake of substrate
b1_SP = 0.06; b2_SP = 0.05; % uptake of substrate 
b1_P  = 0.04; b2_P  = 0.06; % uptake of product
b1_PS = 0.04; b2_PS = 0.06; % uptake of product
