function dXdt = dx (X_t,t)
  ...
  j_EH_AN = max(1e-10,y_E_EN*(m_EN*j_E_AV/y_E_VA + b_EN*X_N));
  %% arrival of carbohydrate in terms of reserves at heterotroph
  j_EH_AC = max(1e-10,y_E_EC*(m_EC*j_E_AV/y_E_VA + b_EC*X_CH));
  %% arrival of reserves synthesized from N and CH at heterotroph 
