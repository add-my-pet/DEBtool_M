...
% [var flux a_b M_E10 M_E20]  = iso_221_var(tXT, p, n_O, n_M)
% created 2012/03/05 by Bas Kooijman
% 2-food, 2-reserve, 1-structure isomorph with variable stoichiometry for growth
%   see iso_221 for fixed stoichiometry
