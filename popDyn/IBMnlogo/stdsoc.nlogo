; Model definition for a std-DEB-structured population with social interaction in a generalized stirred reactor for NetLogo 6.2.0
; Author: Bas Kooijman
; date: 2023/12/17
...
to go
  ...
  set Y (count turtles with [E_H > E_Hb] - 1) / V_X ; % #/dm^3, density of other individuals
