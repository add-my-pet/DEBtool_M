...
Apart from aging, individuals are subjected to stage-specific hazards (h_B0b, h_Bbj, h_Bje ,h_Bei) and, optionally, to thinning (with a hazard equal to the specific growth rate times 2/3).
...
Puberty and birth coincide in the hex model, so the juvenile stage is absent, but a pupa stage is present between the larva and imago stages.
