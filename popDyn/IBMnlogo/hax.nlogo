...
This model simulates the trajectory of a hax-DEB-structured population in a well-stirred generalized reactor, starting from a single newly-produced embryo.
...
Apart from aging, individuals are subjected to stage-specific hazards (h_B0b, h_Bbp, h_Bpj, h_Bje, h_Bei) and, optionally, to thinning (with a hazard equal to the specific growth rate times 2/3).
