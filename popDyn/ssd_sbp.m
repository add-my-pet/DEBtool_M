...
%%
function [stat, txtStat] = ssd_sbp(stat, code, par, T_pop, f_pop, sgr)
  % created 2019/07/30 by Bas Kooijman, modified 2020/02/19
  
  %% Syntax
  % [stat, txtStat]  = <../ssd_sbp.m *ssd_bp*> (stat, code, par, T_pop, f_pop, sgr)
  ...
  pars_qhSL = {aT_b, tT_p, sgr, f, L_b, L_p, L_m, rT_B, vT, g, s_G, hT_a, h_Bbp, h_Bpi, thinning};
...
function dqhSL = dget_qhSL(t, qhSL, a_b, t_p, sgr, f, L_b, L_p, L_m, r_B, v, g, s_G, h_a, h_Bbp, h_Bpi, thinning)
  % t: time since birth
