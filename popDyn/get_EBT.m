  ...
  switch model
    ...
    case 'ssj' 
      ...
      par = {E_Hp, E_Hs, E_Hb, V_X, h_X, ...
          h_J, h_B0b, h_Bbs, h_Bsp, h_Bpi, ...
          h_a, s_G, thin, L_m, E_m, ...
          k_J, k_JX, v, g, p_M, ...
          p_Am, J_X_Am, K, kap, kap_G, ...
          ome, del_sj, E_0, L_b, a_b, ...
          aT_b, q_b, qT_b, h_Ab, hT_Ab};
      txtPar = {'E_Hp, J', 'E_Hs, J', 'E_Hb, J', 'V_X, L', 'h_X, 1/d', ...
          'h_J, 1/d', 'h_B0b, 1/d', 'h_Bbs, 1/d', 'h_Bsp, 1/d', 'h_Bpi, 1/d', ...
          'h_a, 1/d^2', 's_G, -', 'thin, -', 'L_m, cm', '[E_m], J/cm^3', ...
          'k_J, 1/d', 'k_JX, 1/d', 'v, cm/d', 'g, -', '[p_M] J/d.cm^3', ...
          '{p_Am}, J/d.cm^2', '{J_X_Am}, mol/d.cm^2', 'K, mol/L', 'kap, -', 'kap_G, -', ...
          'ome, -', 'del_s, -', 'E_0, J', 'L_b, cm', 'a_b, d', ...
