...
% * reads txNL23W.txt.out for output
  ...
  switch model
    ...
    case 'stx'
      ...
      txtPar = {'tickRate', 't_max', 'X_0', 'V_X', 'mu_X', 'h_X', 'h_B0b', 'h_Bbx', 'h_Bxp', 'h_Bpi', ...
        'thin', 'h_J', 'h_a', 's_G', 'E_Hb', 'E_Hx', 'E_Hp', 'E_Hpm', 'fProb', 'kap', 'kap_X', 'kap_G', 'kap_R', ...
        't_R', 'F_m', 'p_Am', 'p_Amm', 'v', 'p_M', 'k_J', 'k_JX', 'E_G', 'ome'};
    case 'ssj' 
    ...
    case 'asj'
      ...
      txtPar = {'tickRate', 't_max', 'X_0', 'V_X', 'mu_X', 'h_X', 'h_B0b', 'h_Bbs', 'h_Bsj', 'h_Bjp', 'h_Bpi', ...
        ...
        't_R', 'F_m', 'p_Am', 'p_Amm', 'v', 'p_M', 'k_J', 'k_JX', 'E_G', 'ome'};
    case 'abp' % E_0?
      par = {E_Hp, E_Hb, V_X, h_X, h_J, h_B0b, h_Bbp, h_Bpi, h_a, ...
        s_G, thin, L_m, E_m, k_J, k_JX, v, g, ...
        p_M, p_Am, J_X_Am, K, kap, kap_G, ...
        ome, E_0, L_b, a_b, aT_b, q_b, qT_b, h_Ab, hT_Ab};
      txtPar = {'E_Hp', 'E_Hb', 'V_X', 'h_X', 'h_J', 'h_B0b', 'h_Bbp', 'h_Bpi', 'h_a', ...
        's_G', 'thin', 'L_m', 'E_m', 'k_J', 'k_JX', 'v', 'g', ...
        'p_M', 'p_Am', 'J_X_Am', 'K', 'kap', 'kap_G', ...
        'ome', 'E_0', 'L_b', 'a_b', 'aT_b', 'q_b', 'qT_b', 'h_Ab', 'hT_Ab'};
    case 'hep'  % E_0?
      par = {E_Hp, E_Hb, V_X, h_X, h_J, h_B0b, h_Bbp, h_Bpj, h_Bji, h_a, s_G, thin,  ...
        L_m, E_m, k_J, k_JX, v, g, ...
        p_M, p_Am, J_X_Am, K, kap, kap_G, ...
        ome, E_0, E_Rj, L_b, L_j, a_b, aT_b, q_b, qT_b, h_Ab, hT_Ab, numPar.cycle_interval}/ t_m;
      txtPar = {'E_Hp', 'E_Hb', 'V_X', 'h_X', 'h_J', 'h_B0b',  'h_Bbp', 'h_Bpj', 'h_Bji', 'h_a', 's_G', 'thin', ...
        'L_m', 'E_m', 'k_J', 'k_JX', 'v', 'g', ...
        'p_M', 'p_Am', 'J_X_Am', 'K', 'kap', 'kap_G', ...
        'ome', 'E_0', 'E_Rj', 'L_b', 'L_j', 'a_b', 'aT_b', 'q_b', 'qT_b', 'h_Ab', 'hT_Ab', 'N_batch'};
    case 'hax'  % E_0?
      par = {E_Hp, E_Hb, V_X, h_X, h_J, h_B0b, h_Bbp, h_Bpj, h_Bje, h_Bei, h_a, s_G, thin,  ...
        L_m, E_m, k_J, k_JX, v, g, ...
        p_M, p_Am, J_X_Am, K, kap, kap_G, ...
        ome, E_0, E_Rj, L_b, L_j, a_b, aT_b, q_b, qT_b, h_Ab, hT_Ab, numPar.cycle_interval}/ t_m;
      txtPar = {'E_Hp', 'E_Hb', 'V_X', 'h_X', 'h_J', 'h_B0b',  'h_Bbp', 'h_Bpj', 'h_Bje', 'h_Bei', 'h_a', 's_G', 'thin', ...
        'L_m', 'E_m', 'k_J', 'k_JX', 'v', 'g', ...
        'p_M', 'p_Am', 'J_X_Am', 'K', 'kap', 'kap_G', ...
        'ome', 'E_0', 'E_Rj', 'L_b', 'L_j', 'a_b', 'aT_b', 'q_b', 'qT_b', 'h_Ab', 'hT_Ab', 'N_batch'};
    case 'hex'  % E_0?
      par = {E_He, E_Hb, V_X, h_X, h_J, h_B0b, h_Bbj, h_Bje, h_Bei, h_a, s_G, thin,  ...
        L_m, E_m, k_J, k_JX, v, g, p_M, p_Am, J_X_Am, K, kap, kap_G, ...
        ome, E_0, E_Rj, L_b, L_j, L_e, a_b, aT_b, q_b, qT_b, h_Ab, hT_Ab, numPar.cycle_interval}/ t_m;
      txtPar = {'E_He', 'E_Hb', 'V_X', 'h_X', 'h_J', 'h_B0b',  'h_Bbj', 'h_Bje', 'h_Bei', 'h_a', 's_G', 'thin', ...
        'L_m', 'E_m', 'k_J', 'k_JX', 'v', 'g', ...
        'p_M', 'p_Am', 'J_X_Am', 'K', 'kap', 'kap_G', ...
        'ome', 'E_0', 'E_Rj', 'L_b', 'L_j', 'L_e', 'a_b', 'aT_b', 'q_b', 'qT_b', 'h_Ab', 'hT_Ab', 'N_batch'};
  end
