...
% * writes mod.nlogo,  where mod is one of 11 DEB models, and eaLE.txt with embryo settings for interpolation withing NetLogo
...
% * reads txNL23W.txt.out for output
  ...
  switch model
    case {'hax','hex'}
      eaLE = zeros(10,4);
      [e_b, l_b, u_E0, info] =  get_eb_min([g, k, v_He], 1); % minimum value for e_b
      e = linspace(e_b+1e-3, 1, 10);

      for i = 1:10
        [tau_b, l_b] = get_tb([g, k, v_He], e(i));
        u_E0 = get_ue0([g, k, v_Hb], e(i));
        eaLE(i, :) = [e(i), tau_b/ k_M, l_b * L_m, g * E_m * L_m^3 * u_E0];
      end
      oid = fopen('eaLE_pupa.txt', 'w+'); % open file for writing, delete existing content
      for i = 1:10
        fprintf(oid, '%5.4g %5.4g %5.4g %5.4g \n', eaLE(i,1), eaLE(i,2), eaLE(i,3), eaLE(i,4));
      end
      fclose(oid);
  ...
  switch model
    ...
    case {'stdsoc','stdslp'}
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, mu_E, ...
          h_X, h_B0b, h_Bbp, h_Bpi, ...
          thin, h_J, h_a, s_G, ...
          E_Hb, E_Hp, E_Hpm, fProb, ...
          kap, kap_X, kap_G, kap_R, ...
          t_R, k_Y, F_Y, F_m, p_Am, p_Amm, ...
          v, p_M, k_J, k_JX, ...
          E_G, ome};
      txtPar = {'tickRate', ...
          't_max', 'X_0', 'V_X', 'mu_X', 'mu_E', ...
    ...
    case 'stx'
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, ...
          h_X, h_B0b, h_Bbx, h_Bxp, ...
          h_Bpi, thin, h_J, h_a, ...
          s_G, E_Hb, E_Hx, E_Hp, ...
          E_Hpm, fProb, kap, kap_X, ...
          kap_G, kap_R, t_R, F_m, ...
          p_Am, p_Amm, v, p_M, ...
          k_J, k_JX, E_G, ome};
      txtPar = {'tickRate', ...
    ...
    case 'asj'
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, ...
          h_X, h_B0b, h_Bbs, h_Bsj, ...
          h_Bjp, h_Bpi, thin, h_J, ...
          h_a, s_G, E_Hb, E_Hs, ...
          E_Hj, E_Hp, E_Hpm, fProb, ...
          kap, kap_X, kap_G, kap_R, ...
          t_R, F_m, p_Am, p_Amm, ...
          v, p_M, k_J, k_JX, ...
          E_G, ome};
    ...
    case 'hep' 
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, ...
          h_X, h_B0b, h_Bbp, h_Bpj, ...
          h_Bji, thin, h_J, h_a, ...
          s_G, E_Hb, E_Hp, E_Hpm, ...
          E_Rj, fProb, kap, kap_X, ...
          kap_G, kap_R, t_R, F_m,  ...
          p_Am, p_Amm, v, p_M, ...
          k_J, k_JX, E_G, ome};
      txtPar = {'tickRate', ...
    ...
    case 'hax' 
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, ...
          h_X, h_B0b, h_Bbp, h_Bpj, ...
          h_Bje, h_Bei, thin, h_J, ...
          h_a, s_G, E_Hb, E_Hp, ...
          E_Hpm, E_Rj, E_He, fProb, ...
          kap, kap_X, kap_G, kap_R, ...
          t_R, F_m, p_Am, p_Amm, ...
          v, p_M, k_J, k_JX, ...
          E_G, ome};
    ...
    case 'hex'
      par = {tickRate, ...
          t_max, X_0, V_X, mu_X, ...
          h_X, h_B0b, h_Bbj, h_Bje, ...
          h_Bei, thin, h_J, h_a, ...
          s_G, E_Hb, s_j, E_He, ...
          fProb, kap, kap_X, kap_G, ...
          kap_R, t_R, F_m, p_Am, ...
          p_Amm, v, p_M, k_J, ...
          k_JX, E_G, ome};
      txtPar = {'tickRate', ...
  ...
  if runNetLogo
    ...
    txt = fileread('tXNL23W.txt'); ind = strfind(txt,newline); col = length(str2num(txt(1:ind(1)-1)));
    out = fopen('tXNL23W.txt', 'r'); data = fscanf(out,'%e'); fclose(out);
    txNL23W = wrap(data, floor(length(data)/col), col); % output (n/col,col)-array
  else
    path = which('cdCur'); 
    if ismac
      ind = strfind(path,'/'); 
