...
%%
function [stat, txtStat] = ssd_std(stat, code, par, T_pop, f_pop, sgr)
  % created 2019/07/09 by Bas Kooijman, modified 2020/02/19
  
  %% Syntax
  % [stat, txtStat] = <../ssd_std.m *ssd_std*> (stat, code, par, T_pop, f_pop, sgr)
  ...
  % Input
  %
  % * stat: structure to which output is added
  ...
  Y_EX_dead = hL3_bi * L3_bi * f * E_m/ mu_E/ J_X; % mol/mol, yield of dead reserve on food
