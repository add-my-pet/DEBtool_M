...
%fid = fopen(['mydata_', my_pet, '.m'], 'w+'); % open file for reading and writing, delete existing content
fid = fopen('mydata.m', 'w+'); % open file for reading and writing, delete existing content
