...
% modified 2015/07/27 Starrlight 
...
fprintf(oid, '<TR> <TD> &nbsp;  </TD> </TR>\n');
fprintf(oid, '<TR> <TD> &nbsp;</TD> </TR>\n');
fprintf(oid, ['<TR> <TD style="text-align:center"><A class="link" href = "mydata_',metadata.species,'.m" target = "_blank">mydata</A>  </TD></TR>\n']);
fprintf(oid, ['<TR> <TD style="text-align:center"><A class="link" href = "predict_',metadata.species,'.m" target = "_blank">predict</A> </TD> </TR>\n']);
fprintf(oid, ['<TR> <TD style="text-align:center"><A class="link" href = "pars_init_',metadata.species,'.m" target = "_blank">pars_init</A> </TD> </TR>\n']);
...
fprintf(oid, ['<TR> <TD style="text-align:center"><A class="link" href = "results_',metadata.species,'.m" target = "_blank">results</A> </TD> </TR>\n']); % if there is then make a link to it
end
