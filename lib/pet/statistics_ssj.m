...
function [stat, txt_stat] = statistics_ssj(par, chem, T, T_ref, f, model) %% T_ref from metapar or input like T?
% created 2015/07/03 by Starrlight Augustine, modified 2015/07/27 by
% starrlight
