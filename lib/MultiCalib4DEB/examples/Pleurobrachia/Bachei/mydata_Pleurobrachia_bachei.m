...
metaData.address  = {'Akvaplan-niva AS, Fram Centre, P.O. Box 6606 Langnes, 9296 Tromsø, Norway'};   
...
data.Li  = 3;     units.Li  = 'cm';  label.Li  = 'ultimate equatorial diameter'; bibkey.Li  = 'guessed';

data.WC0 = 0.1;   units.WC0 = 'µgC'; label.WC0 = 'initial egg carbon mass'; bibkey.WC0 = 'Hiro1972';
data.Wdi = 90;    units.Wdi = 'mg';  label.Wdi = 'ultimate ash free dry weight'; bibkey.Wdi = 'guessed';
...
%  * *food particle mass*: Labidocera: 0.05 µgC/ind; Acartia adults 3.6 µgC/ind; 
%     calanus nauplii: 0.1 µgC/ind; artemia nauplii 0.5 µgC/ind
...
data.tJX_A = [ ... time since hatch, d  ingestion rate, µgC/d
25.80	4.08
27.91	5.77
30.02	1.04
32.12	2.73
...
94.38	530.59
96.11	423.27];
units.tJX_A   = {'d', 'µgC/d'};  label.tJX_A = {'time since birth', 'ingestion rate'};  
bibkey.tJX_A = 'Hiro1972';
auxData.tJX.tJX_A = data.tJX_A; units.tJX.tJX_A   = {'d', 'µgC/d'};  label.tJX.tJX_A = {'time since birth', 'ingestion rate'};  
%
...
97.34	11.93
99.02	12.77];
units.tL_A   = {'d', 'mm'};  label.tL_A = {'time since birth', 'diameter'};  
...
94.46	680.30
96.34	448.89];
units.tJX_B   = {'d', 'µgC/d'};  label.tJX_B = {'time since birth', 'ingestion rate'};  
bibkey.tJX_B = 'Hiro1972';
auxData.tJX.tJX_B = data.tJX_B; units.tJX.tJX_B   = {'d', 'µgC/d'};  label.tJX.tJX_B = {'time since birth', 'ingestion rate'};  
%
...
97.05	13.56
98.74	13.86];
units.tL_B   = {'d', 'mm'};  label.tL_B = {'time since birth', 'diameter'};  
...
units.tN_B   = {'d', '#'};  label.tN_B = {'time since birth', 'cumulative # of eggs'};  
...
data.tJX_C = [ ... time since hatch, d ingestion rate µgC/d
25.91	1.92
27.91	2
29.81	3.23
32.02	0.61
...
94.10	603.38
96.02	446.82];
units.tJX_C   = {'d', 'µgC/d'};  label.tJX_C = {'time since birth', 'ingestion rate'};  
bibkey.tJX_C = 'Hiro1972'; 
auxData.tJX.tJX_C = data.tJX_C; units.tJX.tJX_C   = {'d', 'µgC/d'};  label.tJX.tJX_C = {'time since birth', 'ingestion rate'};  
%
...
96.77	13.58
98.60	13.67];
units.tL_C   = {'d', 'mm'};  label.tL_C = {'time since birth', 'diameter'};  
...
units.tN_C   = {'d', '#'};  label.tN_C = {'time since birth', 'cumulative # of eggs'};  
...
13.74	65.24
14.51	77.62];
units.LWd   = {'mm', 'mg'};  label.LWd = {'length', 'dry weight'};  
bibkey.LWd = 'Hiro1972';
comment.LWd = 'equatorial length (measured in Hiro1972) is equal to 0.8 polar';

% dioxygen consumption per length at two temperature (µl O2/d)
data.LJO_13 = [ ... diameter, mm dioxygen consumption, µl O2/h
1.99	0.80
2.38	0.70
2.50	0.86
2.77	0.58
...
11.27	18.33
11.66	22.35];
units.LJO_13  = {'mm', 'µl O2/h'};  label.LJO_13 = {'diameter', 'O_2 consumption'};  
temp.LJO_13   = C2K(13);  units.temp.LJO_13 = 'K'; label.temp.LJO_13 = 'temperature';
bibkey.LJO_13 = 'Hiro1972';
% --------------
data.LJO_11 = [ ... diameter, mm dioxygen consumption, µl O2/h
4.89	1.40
5.83	4.35
5.84	2.18
5.89	3.32
...
11.97	17.28
12.00	20.11];
units.LJO_11   = {'mm', 'µl O2/h'};  label.LJO_11 = {'diameter', 'O_2 consumption'};  
...
16.79	39.50
17.40	43.93];
units.LWd_ThibBowe2004   = {'mm', 'mg'};  label.LWd_ThibBowe2004 = {'length', 'dry weight'};  
...
%% Group plots
set1 = {'LJO_13','LJO_11'}; comment1 = {'Data at 13, 11.5 C'};
set2 = {'LWd','LWd_ThibBowe2004'}; comment2 = {'Data for diameter, polar length'};
set3 = {'tL_A','tL_B','tL_C'}; comment3 = {'Individual A, B, C'};
set4 = {'tN_A','tN_B','tN_C'}; comment4 = {'Individual A, B, C'};
set5 = {'tJX_A','tJX_B','tJX_C'}; comment5 = {'Individual A, B, C'};
...
%% Links
metaData.links.id_CoL = 'ea157b9c6d94ac452e22b094c2d3c211'; % Cat of Life
metaData.links.id_EoL = '393303'; % Ency of Life
