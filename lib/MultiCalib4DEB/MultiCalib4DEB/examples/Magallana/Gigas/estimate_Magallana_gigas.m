...
estim_options('max_step_number',10e4); % set options for parameter estimation
estim_options('max_fun_evals',10e4);   % set options for parameter estimation
