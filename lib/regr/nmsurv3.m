...
function [q, info] = nmsurv3(func, p, t, x, y, Z)
  ...
  %% Syntax
  % [q, info] = <../nmsurv3.m *nmsurv3*>(func, p, t, x, y, Z)
  ...
  % Similar to <scsurv3.html *scsurv3*>, but slower and a larger basin of attraction.
  % See <scsurv3.html *scsurv3*> for the definition of the user-defined function, and 
  %     <scsurv.html *scsurv*> and <nmsurv.html *nmsurv*> for univariate data. 
  % It is usually a good idea to run <scsurv3.html *scsurv3*> on the result of nmsurv3.
