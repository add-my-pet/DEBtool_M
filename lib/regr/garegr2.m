...
function [q,info,endPop,bPop,traceInfo] = garegr2(func, p, x, y, Z, W)
  ...
  %% Syntax
  % [q,info,endPop,bPop,traceInfo] = <../garegr2.m *garegr2*>(func, p, x, y, Z, W)
  ...
  % Similar to <nrregr2.html *nrregr2*>, but slower and a larger bassin of attraction.
  % garegr2 calls for: 
  ...
  if 2 ~= sum([nx ny]==size(W)) | nx ~= size_x(1) | ny ~= size_y(1)
