...
function [q, info, endPop, bPop, traceInfo] = gasurv2(func, p, t, y, Z)
  ...
  %% Syntax 
  % [q, info, endPop, bPop, traceInfo] = <../gasurv2.m *gasurv2*>(func, p, t, y, Z)
  ...
  %    ACM Transactions on Mathmatical Software, Submitted 1996; 
  ...
  % Mutation Operators:
  %      boundarymutation multiMonUnifMutation nonUnifMutation unifMutation
  % Selection Functions:
  ...
  %% Example of use
  % See <../mydata_surv2.m *mydata_surv2*>
