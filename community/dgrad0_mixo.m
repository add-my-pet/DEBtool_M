function dX = dgrad0_mixo (t, X_t)
  ...
  dX(1:nX) = dstate0_mixo(t, X_t(1:nX)) - ...  %% local change
  ...
  for i = 2: (nL-1)
    ...
    dX((i-1)*nX + (1:nX)) = dstate0_mixo(t, X_t((i-1)*nX + (1:nX))) - ...
  ...
  %% bottum layer
  j_L_F = j_L_F/ exp(1/Lh);               %% light correction
  dX((nL-1)*nX + (1:nX)) = dstate0_mixo(t, X_t((nL-1)*nX + (1:nX))) - ...
