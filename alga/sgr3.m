...
function [r, jEM, jVM, jER, info] = ...
  ...
  %% Syntax
  % [r, jEM, jVM, jER, info] = <../sgr3.m *sgr3*> (m_E, k_E, j_EM, y_EV, j_VM, a, r0) 
  ...
  %% Remarks
  % cf <sgr1.html *sgr1*>, <sgr2.html *sgr2*> and <sgr4.html *sgr4*> for specific growth rate with 1, 2 and 4 reserves
