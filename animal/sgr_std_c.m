...
%%
function [r, S_b, S_p, aT_b, tT_p, info] = sgr_std_c (par, T_pop, f_pop)
  % created 2019/07/06 by Bas Kooijman
  
  %% Syntax
  % [r, S_b, S_p, aT_b, tT_p, info] = <../sgr_std_c.m *sgr_std*> (par, T_pop, f_pop)
  ...
  if l_p > f || info == 0 || tau_p < 0
    r = 0; S_b = NaN; S_p = NaN; tT_p = NaN; info = 0;
    return
  end
