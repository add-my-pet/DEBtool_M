...
function stat = ssd_asj(stat, code, par, T_pop, f_pop, sgr)
  ...
  pars_qhSL = {sgr, f, kap, kap_R, kT_M, vT, g, k, u_E0, L_b, L_s, L_j, L_i, L_m, tT_s, tT_j, tT_p, rT_j, rT_B, v_Hp, s_G, hT_a, h_Bbs, h_Bsj, h_Bjp, h_Bpi, thinning};
...
function dqhSL = dget_qhSL(t, qhSL, sgr, f, kap, kap_R, k_M, v, g, k, u_E0, L_b, L_s, L_j, L_i, L_m, t_s, t_j, t_p, r_j, r_B, v_Hp, s_G, h_a, h_Bbs, h_Bsj, h_Bjp, h_Bpi, thinning)
...
function [value,isterminal,direction] = p_dead_for_sure(t, qhS, sgr, f, kap, kap_R, k_M, v, g, k, u_E0, L_b, L_s, L_j, L_i, L_m, t_s, t_j, t_p, r_j, r_B, v_Hp, s_G, h_a, h_Bbs, h_Bsj, h_Bjp, h_Bpi, thinning)
