...
%%
function varargout = get_tj_old(p, f, tel_b, tau)
...
%      e_b = f;
    ...
    elseif ~tel_b(2)==f && exist('tau', 'var')
      [tvel, tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B, info] = get_tjm(p, f, tel_b, tau);
      varargout = {tvel, tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B, info};
      return
    elseif ~tel_b(2)==f 
      [tau_j, tau_p, tau_b, l_j, l_p, l_b, l_i, rho_j, rho_B, info] = get_tjm(p, f, tel_b, tau);
