%% scaled_power_abp
% Gets scaled powers as function of length in case of the abp model
%%
function pACSJGRD = scaled_power_abp(L, f, p, lb, lp)
  % created 2024/07/16 by Bas Kooijman
  
  %% Syntax
  % pACSJGRD = <..scaled_power_abp.m *scaled_power_abp*> (L, f, p, lb, lp)
