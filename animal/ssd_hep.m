...
% event pubert
function [value,isterminal,direction] = puberty(t, qhS, sgr, f, k_M, v, g, k, R, L_b, L_p, L_j, L_i, L_m, t_p, t_j, t_N0, r_j, r_B, v_Hp, s_G, h_a, h_Bbp, h_Bpi, thinningg)
  value = t - t_p;  % trigger 
  isterminal = 0;   % terminate pass puberty
