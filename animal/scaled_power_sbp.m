%% scaled_power_sbp
% Gets scaled powers as function of length in case of the sbp model
%%
function pACSJGRD = scaled_power_sbp(L, f, p, lb, lp)
  % created 2024/07/16 by Bas Kooijman
  
  %% Syntax
  % pACSJGRD = <..scaled_power_sbp.m *scaled_power_sbp*> (L, f, p, lb, lp)
  ...
  pC = l.^2 .* ((g + lT) + l )./ (1 + g/ f);   % mobilisation
