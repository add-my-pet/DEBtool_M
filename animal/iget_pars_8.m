...
%%
function data = iget_pars_8(par, fixed_par, chem_par)
  % created 2015/01/19 by Bas Kooijman
  
  %% Syntax
  % data = <../iget_pars_8.m *iget_pars_8*> (par, fixed_par, chem_par)
  ...
  % See <iget_pars_8.m *iget_pars_8*> for the inverse mapping
  ...
  pars_Rm = [kap; kap_R; g; k_J; k_M; L_T; v; U_Hb; U_Hp]; % compose par vector
  R_m = reprod_rate(L_m, 1, pars_Rm); % #/d, maximum reprod rate
